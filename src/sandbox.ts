// //DUMMY file to understand the basic concept of typescript. To use, follow the following step:
// //1. Uncomment all the code except related title & sub-title('Ctrl + /' once ONLY)
// //2. Uncomment script src code in index.html line 46
